    ...
    public class MainExtensions
    {
        public static void SeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasData(
                new User(Guid.NewGuid(), "Nguyễn Lê Nhất Vũ", "shykeuser", "User2004", "0865805582", "Phúc Diễn, Bắc Từ Liêm, Hà Nội", "nhatvu@gmail.com", "2004-01-01", 1),
                new User(Guid.NewGuid(), "ADMIN", "admin", "Admin2004", "0865805582", "nhatvu@gmail.com", "Phúc Diễn, Bắc Từ Liêm, Hà Nội", "2004-01-01", 0)
            );
            /*
